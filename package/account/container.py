...
from .class_func import account_container_func
from .interface import account_interface
from .update_info import account_update_info

class account_container(extra_container_template):
    def __init__(self):
        super().__init__() # 继承父类
        self.function_list.append(account_container_func()) # Default_Template版本仅有一种，不可修改
